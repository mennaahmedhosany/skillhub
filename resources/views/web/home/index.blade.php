            ...
            <div id="courses-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam1.jpg')}}" alt="">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam2.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam3.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam4.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam5.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam6.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam7.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="course">
                            <a href="#" class="course-img">
                                <img src="{{asset('uploads/exam/exam8.jpg')}}" alt="">
                                <i class="course-link-icon fa fa-link"></i>
                            </a>
