@extends('web.layout')
@section('title') Show Skill  {{$skill->name()}} @endsection
@section('main')
        ...
        <div class="row">
            ...
            <div id="main" class="col-md-12">
                ...
                <div class="row">
                    ...
                    <!-- single exam -->
                    @foreach ($skill->exams as $exam ){{-- forgin key  --}}
                    ...
                    <div class="col-md-3">
                        <div class="single-blog">
                            <div class="blog-img">
                                <a href="exam.html">
                                    <img src="{{asset("uploads/exam/$exam->img")}}" alt="">
                                </a>
                            </div>
                            ...
                            <div class="blog-meta">
                                ...
                                <div class="pull-right">
                                    <span class="blog-meta-comments"><a href="#"><i class="fa fa-users"></i> {{$exam->user()->count()}}</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
